...
def call_all_exome_methods_inc_gemini(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	...
	##run gemini
	dobyns_gemini_pipeline_cybertron_v11.standard_gemini_protocol(working_dir, prefix, ped_type)
...
def call_just_coverage(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	os.chdir(working_dir)
	print 'hello'
	##coverage
	calculate_exome_coverage(sample_dict, final_bam_suffix, exome_bed_for_coverage, prefix)
