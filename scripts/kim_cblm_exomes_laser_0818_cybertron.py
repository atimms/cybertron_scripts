...
project_prefix = 'cblm_0818'
project_prefix = 'cblm_0219'
hgdp_all_for_r = project_prefix + '.hgdp_all.txt'
##testing with a few files
# bams_for_analysis = ['LR01-079.bwa_gatk.bam', 'LR01-079f.bwa_gatk.bam', 'LR01-079m.bwa_gatk.bam']
# project_prefix = 'test'
# hgdp_all_for_r = project_prefix + '.hgdp_all.txt'
new_bams = ['LR05-250.bwa_gatk.bam', 'LR05-250f.bwa_gatk.bam', 'LR05-250m.bwa_gatk.bam', 'LR06-137.bwa_gatk.bam', 'LR06-137f.bwa_gatk.bam', 'LR06-137m.bwa_gatk.bam', 'LR09-055.bwa_gatk.bam', 'LR09-055f.bwa_gatk.bam', 'LR09-055m.bwa_gatk.bam', 'LR15-267.bwa_gatk.bam', 'LR15-267f.bwa_gatk.bam', 'LR15-267m.bwa_gatk.bam']

##cblm exomes
##make mpileup files
# samtools_pileup(bams_for_analysis)
##just for new bams
samtools_pileup(new_bams)
