...
def plink_relatadness_check(vcf, file_prefix, work_dir):
	os.chdir(work_dir)
	##correct filtering??
	bcftools_filter = subprocess.Popen(['bcftools', 'view', '-f', 'PASS', '-i', "QUAL>50 & MIN(INFO/DP)>30", '-V', 'indels', '-o', file_prefix + 'temp_plink.vcf.gz', '-O', 'z', vcf])
	bcftools_filter.wait()
	...
	plink_sex = subprocess.Popen([plink, '--bfile', file_prefix + 'temp.pass_q50_dp50', '--check-sex', '--out', file_prefix + '.pass_q50_dp50'])
	plink_sex.wait()
	##ibd check
	plink_ibd = subprocess.Popen([plink,  '--bfile', file_prefix + 'temp.pass_q50_dp50', '--genome', '--out', file_prefix + '.pass_q50_dp50'])
	plink_ibd.wait()
...
##run all at once
work_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819'
input_file = 'daniela_genomes_0819.txt'
...
input_file = 'daniela_genomes_0819_1.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819/b2'
input_file = 'daniela_genomes_0819_2.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819/b3'
input_file = 'daniela_genomes_0819_3.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819/b4'
input_file = 'daniela_genomes_0819_4.txt'
# run_analysis(work_dir, input_file, uw_vcf)

##repeat 3 peds with issues
work_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819'
input_file = 'daniela_genomes_0819_rpts.txt'
run_analysis(work_dir, input_file, uw_vcf)

##check relatedness
peds_to_analyze = ['CFM-MOS-11', 'CFM-MOS-12', 'CL1003', 'CL1020', 'CL3003', 'CL3023', 'CL3033', 'CL3044', 'CL3045', 'CL4001', 'CL4004', 'CL4005', 'CL4007', 'F003', 
	'F005', 'F007', 'F008', 'F009', 'F011', 'F015', 'F016', 'F017', 'F0200003', 'F0200013', 'F0200022', 'F020', 'F022', 'F027', 'F028', 'F0400012', 'F0400020', 'F040', 
	'F041', 'F042', 'F045', 'F047', 'F050', 'F093', 'F149', 'F150', 'F152', 'F154', 'F168', 'PM1010017', 'PM1010036', 'PM1010037', 'PM1010039', 'PM1010040', 'PM1010042', 
	'PM1010043', 'PM1010044', 'PM1010045', 'PM1030019', 'PM1030021', 'PM1030022', 'PM1030025', 'PM1030028', 'PM1030029', 'PM1030030', 'PM1030031', 'PM1060018', 'PM1060019', 
	'PM1060028', 'PM1060029', 'PM1060030', 'PM1060032', 'PM1070005', 'PM1070017', 'PM1070019', 'PM1070020', 'PM4010001', 'PM4010003', 'PM4010004', 'PM4010005']
repeated_peds = ['PM1010037', 'PM1010040', 'PM1030022']
duo_list = ['CL3003', 'CL3023', 'CL3051', 'F040', 'PM1010037'] ##CL3051 not analyzed in this batch
single_list = ['CFM-MOS-11', 'F168']
# single_list = ['CFM-MOS-11', 'F168']
working_dir = '/home/atimms/ngs_data/genomes/daniela_uw_vcf_0819'
##first time
# for ped in peds_to_analyze:
# 	vcf_file = ped + '.vcf.gz'
# 	plink_relatadness_check(vcf_file, ped, working_dir)
##on 3 repeated peds
# for ped in repeated_peds:
# 	vcf_file = ped + '.vcf.gz'
# 	plink_relatadness_check(vcf_file, ped, working_dir)
