...
##installing again 0820 - so uses latest conda

##set environment to use, and set up dependancies
conda create --name hg38_genomes
conda activate hg38_genomes 
##instally dependancies, beforehand.. make file in 
##/home/atimms/programs/miniconda3/envs/hg38_genomes/conda-meta called 
...
##if issue with pip requirements do this...
...
##other tools for analysis in genomes
...
fasta = '/home/atimms/ngs_data/references/hg38_broad/hg38_v0_Homo_sapiens_assembly38.fasta'
##vcfanno_files
...
def gemini_protocol(pedigree_dict):
	for pedigree in pedigree_dict:
		...
		if ped_type == 'singleton':
			...
			##not used right now
			##make auto dom ped and gemini db for trio analysis
...
##run methods
work_dir = '/home/atimms/ngs_data/genomes/ghayda_LR18-333a1_0820'
vcf = '/home/atimms/ngs_data/genomes/ghayda_LR18-333a1_0820/SL299918/SL299918.vcf.gz'
sample_file = 'LR18-333a1_0820.txt'
run_analysis(work_dir, sample_file, vcf)
