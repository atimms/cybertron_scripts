...
def load_single_vcf_into_gemini(ped, db_name, input_vcf, ped_file):
	...
	gemini_load = subprocess.Popen([gemini, 'load', '-t', 'snpEff', '-p', ped_file, '--tempdir', gemini_temp_dir,  '-v', normalized_vcf + '.gz', db_name])
	gemini_load.wait()
...
def call_after_mapping(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	...
	##run gemini
	standard_gemini_protocol(working_dir, prefix, ped_type)


##run methods
##mapping run
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b1", "LR08-081", "bam", {'LR08-081': 'HD1811041.bam', 'LR08-081f': 'HD1803052.bam', 'LR08-081m': 'HD1804022.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b1", "LR09-004", "bam", {'LR09-004': 'HD1404072.bam', 'LR09-004f': 'HD1404073.bam', 'LR09-004m': 'HD1404074.bam'}, "trio")
call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b1", "LR14-331", "bam", {'LR14-331': 'HD1411037.bam', 'LR14-331m': 'HD1411038.bam', 'LR14-331pgf': 'HD1811021.bam', 'LR14-331pgm': 'HD1811022.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b2", "LR16-002", "bam", {'LR16-002': 'HD1609055.bam', 'LR16-002f': 'HD1609056.bam', 'LR16-002m': 'HD1609057.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b2", "LR16-404", "bam", {'LR16-404': 'HD1612020.bam', 'LR16-404f': 'HD1612021.bam', 'LR16-404m': 'HD1612022.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b3", "LR18-545", "bam", {'LR18-545': 'HD1901009.bam', 'LR18-545f': 'HD1901010.bam', 'LR18-545m': 'HD1901011.bam', 'LR18-545s1': 'HD1901012.bam'}, "trio")



##mapping still running
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b2", "LR16-405", "bam", {'LR16-405': 'HD1904017.bam', 'LR16-405f': 'HD1904018.bam', 'LR16-405m': 'HD1904019.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b2", "LR17-398", "bam", {'LR17-398': 'HD1905034.bam', 'LR17-398f': 'HD1710029.bam', 'LR17-398m': 'HD1710030.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b3", "LR19-005", "bam", {'LR19-005': 'HD1905031.bam', 'LR19-005f': 'HD1905127.bam', 'LR19-005m': 'HD1905128.bam'}, "trio")
# call_after_mapping("/home/atimms/ngs_data/exomes/working/ghayda_broad_exomes_0920/b3", "LR19-356", "bam", {'LR19-356': 'HD1905121.bam', 'LR19-356f': 'HD1906013.bam', 'LR19-356m': 'HD1905122.bam'}, "trio")
