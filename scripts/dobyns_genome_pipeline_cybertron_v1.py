...
def catch_up(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	os.chdir(working_dir)
	##covert bam to fastq and then process
	# '''
	if bam_or_fastq == 'bam':
...
def variant_calling_plus(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	os.chdir(working_dir)
	##variant calling
	make_list_of_bams(sample_dict, final_bam_suffix, bamlist)
	variant_calling_freebayes(bamlist, prefix)
...
def call_just_mapping(working_dir, prefix, bam_or_fastq, sample_dict, ped_type):
	...
	if bam_or_fastq == 'bam':
		...
		print 'must specify if starting with fastq or bam file'
	delete_unwated_files(['*.r1.fastq', '*.r2.fastq', '*.bwa.bam', '*.bwa_sort.bam', '*.metrics', '*.bwa_religned.bam', '*.bwa_religned.bai', '*.recal_data.table', '*bwa_mkdup.bai', '*bwa_mkdup.bam'])
...
# call_all_exome_methods_inc_gemini(working_dir, 'LR14-088', 'bam', {'LR14-088':'PG0006685-BLD.bam', 'LR14-088f':'PG0006686-BLD.bam', 'LR14-088m':'PG0006688-BLD.bam'}, 'trio')
# catch_up(working_dir, 'LR14-088', 'bam', {'LR14-088':'PG0006685-BLD.bam'}, 'trio')
# variant_calling_plus(working_dir, 'LR14-088', 'bam', {'LR14-088':'PG0006685-BLD.bam', 'LR14-088f':'PG0006686-BLD.bam', 'LR14-088m':'PG0006688-BLD.bam'}, 'trio')
# call_just_gemini(working_dir, 'LR14-088', 'bam', {'LR14-088':'PG0006685-BLD.bam', 'LR14-088f':'PG0006686-BLD.bam', 'LR14-088m':'PG0006688-BLD.bam'}, 'trio')

##ghayda ped 1117
working_dir = '/home/atimms/ngs_data/genomes/LR16-302'
##complete in one shot
# call_all_exome_methods_inc_gemini(working_dir, 'LR16-302', 'fastq', {'LR16-302':['UDN388987.r1.fastq.gz', 'UDN388987.r2.fastq.gz'], 'LR16-302f':['UDN726371.r1.fastq.gz', 'UDN726371.r2.fastq.gz'], 'LR16-302m':['UDN222967.r1.fastq.gz', 'UDN222967.r2.fastq.gz']}, 'trio')
##map the three at the same time, make coppies of script
# call_just_mapping(working_dir, 'LR16-302', 'fastq', {'LR16-302':['UDN388987.r1.fastq.gz', 'UDN388987.r2.fastq.gz']}, 'trio')
# call_just_mapping(working_dir, 'LR16-302f', 'fastq', {'LR16-302f':['UDN726371.r1.fastq.gz', 'UDN726371.r2.fastq.gz']}, 'trio')
# call_just_mapping(working_dir, 'LR16-302m', 'fastq', {'LR16-302m':['UDN222967.r1.fastq.gz', 'UDN222967.r2.fastq.gz']}, 'trio')
##all the rest
# variant_calling_plus(working_dir, 'LR16-302', 'fastq', {'LR16-302':['UDN388987.r1.fastq.gz', 'UDN388987.r2.fastq.gz'], 'LR16-302f':['UDN726371.r1.fastq.gz', 'UDN726371.r2.fastq.gz'], 'LR16-302m':['UDN222967.r1.fastq.gz', 'UDN222967.r2.fastq.gz']}, 'trio')
##jusr gemini
# intersect_vcfs_and_gemini(working_dir, 'LR16-302', 'fastq', {'LR16-302':['UDN388987.r1.fastq.gz', 'UDN388987.r2.fastq.gz'], 'LR16-302f':['UDN726371.r1.fastq.gz', 'UDN726371.r2.fastq.gz'], 'LR16-302m':['UDN222967.r1.fastq.gz', 'UDN222967.r2.fastq.gz']}, 'trio')

##hli genomes

##mapping step
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes'
# call_just_mapping(working_dir, 'LR11-016', 'bam', {'LR11-016':'1112053.bam', 'LR11-016f':'1304135.bam', 'LR11-016m':'1304136.bam'}, 'trio')
# call_just_mapping(working_dir, 'LR12-101', 'bam', {'LR12-101_s1':'1206006.bam', 'LR12-101_s2':'1207020.bam', 'LR12-101f':'1206140.bam', 'LR12-101m':'1206141.bam'}, 'trio')
# call_just_mapping(working_dir, 'LR03-037', 'bam', {'LR03-037a1':'6_1075.bam', 'LR03-037a2':'1203025.bam', 'LR03-037f':'7_1862.bam', 'LR03-037m':'7_1863.bam'}, 'trio')
# call_just_mapping(working_dir, 'LR01-190', 'bam', {'LR01-190_saliva':'1106022.bam', 'LR01-190_tooth':'1603071.bam', 'LR01-190f':'1106023.bam', 'LR01-190m':'1106024.bam'}, 'trio')
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes/extra'
# call_just_mapping(working_dir, 'LR08-002', 'bam', {'LR08-002':'8_0576.bam', 'LR08-002f':'8_0577.bam', 'LR08-002m':'8_0578.bam'}, 'trio')
# call_just_mapping(working_dir, 'LR11-006', 'bam', {'LR11-006':'1105139.bam', 'LR11-006f':'1105140.bam', 'LR11-006m':'1105141.bam'}, 'trio')

##variant calling plus
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes'
# variant_calling_plus(working_dir, 'LR11-016', 'bam', {'LR11-016':'1112053.bam', 'LR11-016f':'1304135.bam', 'LR11-016m':'1304136.bam'}, 'trio')
# variant_calling_plus(working_dir, 'LR12-101', 'bam', {'LR12-101_s1':'1206006.bam', 'LR12-101_s2':'1207020.bam', 'LR12-101f':'1206140.bam', 'LR12-101m':'1206141.bam'}, 'trio')
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes/extra'
# variant_calling_plus(working_dir, 'LR08-002', 'bam', {'LR08-002':'8_0576.bam', 'LR08-002f':'8_0577.bam', 'LR08-002m':'8_0578.bam'}, 'trio')
# variant_calling_plus(working_dir, 'LR11-006', 'bam', {'LR11-006':'1105139.bam', 'LR11-006f':'1105140.bam', 'LR11-006m':'1105141.bam'}, 'trio')
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes/extra2'
# variant_calling_plus(working_dir, 'LR03-037', 'bam', {'LR03-037a1':'6_1075.bam', 'LR03-037a2':'1203025.bam', 'LR03-037f':'7_1862.bam', 'LR03-037m':'7_1863.bam'}, 'trio')
working_dir = '/home/atimms/ngs_data/genomes/hli_genomes/extra3'
# variant_calling_plus(working_dir, 'LR01-190', 'bam', {'LR01-190_saliva':'1106022.bam', 'LR01-190_tooth':'1603071.bam', 'LR01-190f':'1106023.bam', 'LR01-190m':'1106024.bam'}, 'trio')

##ghayda ped 0320
working_dir = '/home/atimms/ngs_data/genomes/ghayda_0420_LR18-556'
##complete in one shot
# call_all_exome_methods_inc_gemini(working_dir, 'LR18-556', 'fastq', {'LR18-556':['HKKLMCCXY_s1_1_GSLv3-7_24_SL316117.fastq.gz', 'HKKLMCCXY_s1_2_GSLv3-7_24_SL316117.fastq.gz']}, 'singleton')
##forgot ped file - add and run gemini
call_just_gemini(working_dir, 'LR18-556', 'fastq', {'LR18-556':['HKKLMCCXY_s1_1_GSLv3-7_24_SL316117.fastq.gz', 'HKKLMCCXY_s1_2_GSLv3-7_24_SL316117.fastq.gz']}, 'singleton')
