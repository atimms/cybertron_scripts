...
##lists of peds
duo_list = ['CA-02-010_duo', '401-0020', 'CA-04-007']
single_list = ['BCS-01', 'CA-02-013_sibs']
...
##run all at once
work_dir = '/home/atimms/ngs_data/genomes/daniela_genomes_0620'
input_file = 'daniela_genomes_0620.txt'
# input_file = 'daniela_genomes_0620_temp.txt'
uw_vcf = 'luquetti_grc_wgs_2.HF.final.vcf.gz'
##for vcf/ped files
# run_analysis(work_dir, input_file, uw_vcf)

'''
##for gemini part, takes a while, so split peds
input_file = 'daniela_genomes_0620_1.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_genomes_0620/b2'
input_file = 'daniela_genomes_0620_2.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_genomes_0620/b3'
input_file = 'daniela_genomes_0620_3.txt'
# run_analysis(work_dir, input_file, uw_vcf)
work_dir = '/home/atimms/ngs_data/genomes/daniela_genomes_0620/b4'
input_file = 'daniela_genomes_0620_4.txt'
run_analysis(work_dir, input_file, uw_vcf)
'''

##combined files, three ways all trios (std), all trios (auto dom), and duos/singeltons
peds_to_analyze = ['CA-02-010_duo', '401-0020', 'CA-04-007', 'CA-02-013_sibs', '03-0021', '101-0050', '101-0055', '101-0060', 
		'101-0061', '101-0062', '101-0064', '101-0066', '103-0036', '103-0060', '103-0062', '106-0041', '107-0029', '107-0031', 
		'107-0039', '401-0008', '401-0013', 'CA-01-004', 'CA-01-011', 'CA-02-007', 'CA-02-010_trio', 'CA-02-013_quad', 
		'CA-03-011', 'CA-03-012', 'CA-03-016', 'CA-03-047', 'CA-03-049', 'CA-04-004', '103-0041', '107-0030', 'CA-03-030', 'CLOCK-01-042']
