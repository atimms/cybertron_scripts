...
working_dir = '/home/atimms/ngs_data/enu_mapping/sophie_ol_0919'
...
old_fq_dict = {'K50022': ['K50022.r1.fastq.gz', 'K50022.r2.fastq.gz', ['K50000022.r1.fq.gz', 'K50022_USD16090355L_HJJYLDSXX_L2_1.fq.gz'], 
...
new_fq_dict = {'K500635': ['K500635.r1.fastq.gz', 'K500635.r2.fastq.gz', ['K500635_USD16094341L_HMHTNDSXX_L1_1.fq.gz'], 
		['K500635_USD16094341L_HMHTNDSXX_L1_2.fq.gz']],
		'K500651': ['K500651.r1.fastq.gz', 'K500651.r2.fastq.gz', ['K500651_CDSW100075931-1A_HMFNJDSXX_L2_1.fq.gz', 'K500651_USD16094342L_HNLMMDSXX_L1_1.fq.gz'], 
		['K500651_CDSW100075931-1A_HMFNJDSXX_L2_2.fq.gz', 'K500651_USD16094342L_HNLMMDSXX_L1_2.fq.gz']],
		'K500653': ['K500653.r1.fastq.gz', 'K500653.r2.fastq.gz', ['K500653_CDSW100072399-1A_HMFNJDSXX_L2_1.fq.gz', 'K500653_USD16094343L_HNLMMDSXX_L1_1.fq.gz'], 
		['K500653_CDSW100072399-1A_HMFNJDSXX_L2_2.fq.gz', 'K500653_USD16094343L_HNLMMDSXX_L1_2.fq.gz']],
		'K500654': ['K500654.r1.fastq.gz', 'K500654.r2.fastq.gz', ['K500654_CDSW100010989-1A_HLCHLDSXX_L1_1.fq.gz', 'K500654_USD16094344L_HNLMMDSXX_L1_1.fq.gz'], 
		['K500654_CDSW100010989-1A_HLCHLDSXX_L1_2.fq.gz', 'K500654_USD16094344L_HNLMMDSXX_L1_2.fq.gz']],
		'K500655': ['K500655.r1.fastq.gz', 'K500655.r2.fastq.gz', ['K500655_CDSW100064555-1A_HLCHLDSXX_L1_1.fq.gz', 'K500655_USD16094345L_HNLMMDSXX_L1_1.fq.gz'], 
		['K500655_CDSW100064555-1A_HLCHLDSXX_L1_2.fq.gz', 'K500655_USD16094345L_HNLMMDSXX_L1_2.fq.gz']]}

combined_samples = old_fq_dict.keys() + new_fq_dict.keys()

##map with bwa and process with samtools etc
# for sample in new_fq_dict:
# 	combine_fq_file(new_fq_dict[sample][2], new_fq_dict[sample][3], new_fq_dict[sample][0], new_fq_dict[sample][1])
# align_with_bwa(new_fq_dict)
# variant_calling_samtools(new_fq_dict, mkdup_bam, st_vcf_suffix)
# convert_to_annovar(combined_samples, st_vcf_suffix + '.gz')
# run_table_annovar(combined_samples)
# multianno_to_annotated(combined_samples)
...
##get snps that are in all samples
get_shared_snps(samples, enu_file_suffix, share_file)

##get exonic snps that are in all samples
