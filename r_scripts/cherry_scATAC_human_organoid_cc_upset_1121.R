...
setwd('/home/atimms/ngs_data/misc/cherry_sc_org_project_20/cherry_scatac_corr_rpts_1021/')

##test on one set of data
##read in data -- adding summary meg/mic to phenotypes
links <- read.table('diff_peaks_rep.bg.28wk_organoid_adult_human.all_peaks.balanced.bt_int.mature_cc.upset.txt', header=T, sep='\t')
...
dev.copy2pdf(file='diff_peaks_rep.bg.adult_human_28wk_organoid.balanced.bt_int.mature_cc.test.upset.pdf', width = 12, height = 6)
