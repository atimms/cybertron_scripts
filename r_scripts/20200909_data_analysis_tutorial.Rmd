...
## We can finding genes that vary between groups of cells in UMAP or t-SNE space by calling the graph_test() function
```{r echo=FALSE}
ciliated_genes = c("che-1",
                   "hlh-17",
                   "nhr-6",
...
Hint: Check the morans_I column, which ranges from -1 to +1.
...
# This function fits a principal graph within each parition.
