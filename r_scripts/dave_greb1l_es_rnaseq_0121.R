...
workingDir = "/home/atimms/ngs_data/rnaseq/dave_greb1l_es_cell_rnaseq_0121";
setwd(workingDir);

###dave_greb1l_esc_0121
##read in count and metadata -- using counts using subset of genes
countData1 <- read.table('dave_greb1l_esc_0121.star_fc.counts.txt', header=T, row.names=1)
colData1 <- read.table('dave_greb1l_esc_0121.star_fc.metadata.txt', header=T, row.names=1)
head(countData1)
head(colData1)
...
#write.csv(assay(rld), file="dave_greb1l_esc_0121.deseq.vst_counts.csv")
...
pheatmap(sampleDistMatrix,
         ...
         col=colors)
dev.copy2pdf(file='dave_greb1l_esc_0121.sample_heatmap.pdf', width = 7, height = 5)
##principal components analysis 
plotPCA(rld, intgroup = c("time_point"))
ggsave('dave_greb1l_esc_0121.timepoint_pca.pdf', width=6, height = 6)
plotPCA(rld, intgroup = c("genotype"))
ggsave('dave_greb1l_esc_0121.genotype_pca.pdf', width=6, height = 6)
...
dev.copy2pdf(file='dave_greb1l_esc_0121.25_var_gene_clustering.pdf', width = 9, height = 6)

########################

###es_cells_0920_day0
##read in count and metadata -- using counts using subset of genes
countData1 <- read.table('dave_greb1l_esc_0121_d0.star_fc.counts.txt', header=T, row.names=1)
colData1 <- read.table('dave_greb1l_esc_0121_d0.star_fc.metadata.txt', header=T, row.names=1)
head(countData1)
head(colData1)
##convert column of numbers to a factor
colData1$genotype <- as.factor(colData1$genotype)
...
pheatmap(sampleDistMatrix,
         ...
         clustering_distance_cols=sampleDists,
         col=colors)
dev.copy2pdf(file='dave_greb1l_esc_0121_d0.sample_heatmap.pdf', width = 7, height = 5)
##principal components analysis 
plotPCA(rld, intgroup = c("genotype"))
ggsave('dave_greb1l_esc_0121_d0.genotype_pca.pdf', width=6, height = 6)
...
pheatmap(mat, annotation_col=newdf, fontsize_row=8, fontsize_col=8)
dev.copy2pdf(file='dave_greb1l_esc_0121_d0.25_var_gene_clustering.pdf', width = 9, height = 6)
...
###es_cells_0920_day4
##read in count and metadata -- using counts using subset of genes
countData1 <- read.table('dave_greb1l_esc_0121_d4.star_fc.counts.txt', header=T, row.names=1)
colData1 <- read.table('dave_greb1l_esc_0121_d4.star_fc.metadata.txt', header=T, row.names=1)
head(countData1)
head(colData1)
##convert column of numbers to a factor
colData1$genotype <- as.factor(colData1$genotype)
...
pheatmap(sampleDistMatrix,
         ...
         clustering_distance_cols=sampleDists,
         col=colors)
dev.copy2pdf(file='dave_greb1l_esc_0121_d4.sample_heatmap.pdf', width = 7, height = 5)
##principal components analysis 
plotPCA(rld, intgroup = c("genotype"))
ggsave('dave_greb1l_esc_0121_d4.genotype_pca.pdf', width=6, height = 6)
...
newdf <- as.data.frame(colData(rld)[c("genotype")])
pheatmap(mat, annotation_col=newdf, fontsize_row=8, fontsize_col=8)
dev.copy2pdf(file='dave_greb1l_esc_0121_d4.25_var_gene_clustering.pdf', width = 9, height = 6)
...
###es_cells_0920_day8
##read in count and metadata -- using counts using subset of genes
countData1 <- read.table('dave_greb1l_esc_0121_d8.star_fc.counts.txt', header=T, row.names=1)
colData1 <- read.table('dave_greb1l_esc_0121_d8.star_fc.metadata.txt', header=T, row.names=1)
head(countData1)
head(colData1)
##convert column of numbers to a factor
colData1$genotype <- as.factor(colData1$genotype)
...
pheatmap(sampleDistMatrix,
         ...
         clustering_distance_cols=sampleDists,
         col=colors)
dev.copy2pdf(file='dave_greb1l_esc_0121_d8.sample_heatmap.pdf', width = 7, height = 5)
##principal components analysis 
plotPCA(rld, intgroup = c("genotype"))
ggsave('dave_greb1l_esc_0121_d8.genotype_pca.pdf', width=9, height = 6)
...
newdf <- as.data.frame(colData(rld)[c("genotype")])
pheatmap(mat, annotation_col=newdf, fontsize_row=8, fontsize_col=8)
dev.copy2pdf(file='dave_greb1l_esc_0121_d8.25_var_gene_clustering.pdf', width = 9, height = 6)
