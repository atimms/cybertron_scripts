...
human_harmony <- readRDS(file = "./seurat_analysis/all/human_harmony_clusters_defined.rds")
DotPlot(human_harmony, features = markers_0122) + RotatedAxis()
dev.copy2pdf(file="./seurat_analysis/all/human_scrnaseq_all_0620.res0.4.SLC16_genes_0122.dotplot.pdf", width = 12, height = 6)
