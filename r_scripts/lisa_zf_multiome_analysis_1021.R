...
# move to working dir
workingDir = "/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis";
setwd(workingDir);
...
WT_1.data <- Read10X_h5("/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/WT_1/outs/filtered_feature_bc_matrix.h5")
...
frag.file <- "/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/WT_1/outs/atac_fragments.tsv.gz"
...
# Look at QC metrics
VlnPlot(WT_1, features = c("nCount_ATAC", "nCount_RNA","percent.mt"), ncol = 3,
...
# the 10x hdf5 file contains both data types.
WT_2.data <- Read10X_h5("/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/WT_2/outs/filtered_feature_bc_matrix.h5")
...
frag.file <- "/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/WT_2/outs/atac_fragments.tsv.gz"
chrom_assay <- CreateChromatinAssay(
  counts = atac_counts,
  sep = c(":", "-"),
  genome = 'danRer11',
...
# Look at QC metrics
VlnPlot(WT_2, features = c("nCount_ATAC", "nCount_RNA","percent.mt"), ncol = 3,
        log = TRUE, pt.size = 0) + NoLegend()
...
# the 10x hdf5 file contains both data types.
dmd_1.data <- Read10X_h5("/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/dmd_1/outs/filtered_feature_bc_matrix.h5")
...
frag.file <- "/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/dmd_1/outs/atac_fragments.tsv.gz"
chrom_assay <- CreateChromatinAssay(
  counts = atac_counts,
  sep = c(":", "-"),
  genome = 'danRer11',
...
# Look at QC metrics
VlnPlot(dmd_1, features = c("nCount_ATAC", "nCount_RNA","percent.mt"), ncol = 3,
        log = TRUE, pt.size = 0) + NoLegend()
...
# the 10x hdf5 file contains both data types.
dmd_2.data <- Read10X_h5("/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/dmd_2/outs/filtered_feature_bc_matrix.h5")
...
frag.file <- "/home/atimms/ngs_data/cellranger/lisa_zf_multiome_1021/standard_analysis/dmd_2/outs/atac_fragments.tsv.gz"
chrom_assay <- CreateChromatinAssay(
  counts = atac_counts,
  sep = c(":", "-"),
  genome = 'danRer11',
...
# Look at QC metrics
VlnPlot(dmd_2, features = c("nCount_ATAC", "nCount_RNA","percent.mt"), ncol = 3,
        log = TRUE, pt.size = 0) + NoLegend()
...
DimPlot(comb, reduction='umap.rna', split.by='sample', pt.size=0.1, label = F)
dev.copy2pdf(file="umap_rna.split_by_sample.pdf", width=20)
DimPlot(comb, reduction='umap.rna', pt.size=0.1, label = F)
...
DimPlot(comb, reduction='umap.rna',group.by="genotype", pt.size=0.1, label = F)
dev.copy2pdf(file="umap_rna.by_genotype.pdf", width=20)
...
DimPlot(comb, reduction='umap.atac', pt.size=0.1, label = F)
dev.copy2pdf(file="umap_atac.harmony.by_sample.pdf", width=20)
DimPlot(comb, reduction='umap.atac',group.by="genotype", pt.size=0.1, label = F)
dev.copy2pdf(file="umap_atac.harmony.by_genotype.pdf", width=20)
...
comb.de = FindAllMarkers(comb, only.pos = TRUE, logfc.threshold = 0.25)
...
Idents(comb) = 'genotype'
comb_atac.de = FindAllMarkers(comb, only.pos = TRUE, logfc.threshold = 0.25)
write.csv(comb_atac.de, file = 'ATAC_genotype_markers.csv')

##get number of cells per cluster and per sample/genotype
#breakdown<-table(seuratObject@metadata$seurat_clusters, seuratObject@metadata$sample)
##? need metadata or just comb$sample
cluster_sample_counts = table(comb$seurat_clusters, comb$sample)
write.csv(cluster_sample_counts, file='counts.cluster_sample.csv')
